            ...
            <div className='flex-1 flex flex-col'>
                <div className='flex justify-between items-start gap-5 flex-wrap pb-6'>
                    <div className='flex flex-col gap-3'>
                        ...
                        <Link 
                            href={product.url} target="_blank" className="text-base text-black opacity-50">Visit product
                        </Link>
                    </div>
                    <div className='flex items-center gap-3'>
                        ...
                        <div className='p-2 bg-white-200 rounded-10'>
                            <Image src="/assets/icons/bookmark.svg" alt="bookmark"
                            width={20}
                            height={20}
                            />
                        </div>
                    ...
                    <div className='flex flex-col gap-4'>
                        <div className='flex gap-3'>
                            ...
                            <div className='product-reviews'>
                                <Image src='/assets/icons/comment.svg' alt="comment"
                                width={16}
                                height={16}
                                />
                        ...
                        <p className='text-sm text-black opacity-50'>
                            <span className='text-primary-green font-semibold'>93%</span> of buyers recommed this
                        </p>
                    </div>
                </div>
